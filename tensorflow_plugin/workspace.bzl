...
def amd_cpu_plugin_workspace(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        sha256 = "b7188ee0b9dda6c9948d686fef6d9636ebf32b177c5379074b2258ad2326ace8",
        strip_prefix = "blis-AOCL-Jun2025-b2",
        urls = tf_mirror_urls("https://github.com/amd/blis/archive/refs/tags/AOCL-Jun2025-b2.tar.gz"),
    )

    tf_http_archive(
        name = "zen_dnn",
        build_file = "//third_party/zen_dnn:zen.BUILD",
        sha256 = "4f9d6fe79f66bbb63e23b008c0f3010247fe44a3c5b2667345698cbb2025cbcb",
        strip_prefix = "ZenDNN-zendnn-2025-WW26",
        urls = tf_mirror_urls("https://github.com/amd/ZenDNN/archive/refs/tags/zendnn-2025-WW26.tar.gz"),
    )
