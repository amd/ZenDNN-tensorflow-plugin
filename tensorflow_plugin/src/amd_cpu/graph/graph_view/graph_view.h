...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_GRAPH_VIEW_GRAPH_VIEW_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_GRAPH_VIEW_GRAPH_VIEW_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_GRAPH_VIEW_GRAPH_VIEW_H_
