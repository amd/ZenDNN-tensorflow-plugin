...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_UTILS_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_UTILS_H_
...
// DUMP_GRAPH_PREFIX environment variable if 'dirname' is empty, and suffixes
...
// Returns true if the node is assigned to run on specific device.
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_UTILS_H_
