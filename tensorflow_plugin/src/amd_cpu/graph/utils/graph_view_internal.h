...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_GRAPH_VIEW_INTERNAL_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_GRAPH_VIEW_INTERNAL_H_
...
class NodeViewInternal {
 ...
 protected:
  virtual const FanoutViewT& GetMissingFanin() const = 0;
  virtual const std::vector<FaninViewT>& GetMissingFanout() const = 0;
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_GRAPH_VIEW_INTERNAL_H_
