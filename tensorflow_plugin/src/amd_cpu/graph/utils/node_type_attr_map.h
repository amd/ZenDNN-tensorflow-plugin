...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_NODE_TYPE_ATTR_MAP_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_NODE_TYPE_ATTR_MAP_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_GRAPH_UTILS_NODE_TYPE_ATTR_MAP_H_
