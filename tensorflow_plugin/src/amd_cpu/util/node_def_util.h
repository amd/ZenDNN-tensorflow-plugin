...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_NODE_DEF_UTIL_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_NODE_DEF_UTIL_H_
...
// Node objects are actually specified as amd_cpu_plugin::NodeDef protocol
// buffers, which contain many other fields that are not (currently) validated.
//
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_NODE_DEF_UTIL_H_
