...
#include "tensorflow_plugin/src/amd_cpu/util/stacktrace.h"

namespace amd_cpu_plugin {

Status::Status(TF_Code code, amd_cpu_plugin::StringPiece msg) {
  code_ = code;
  message_ = string(msg);
...
std::string* TfCheckOpHelperOutOfLine(const ::amd_cpu_plugin::Status& v,
                                      const char* msg) {
