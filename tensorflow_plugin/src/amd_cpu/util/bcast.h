...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_BCAST_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_BCAST_H_
...
class BCastList {
 public:
  ...
  // Returns true if two operands are compatible according to the
  // broadcasting rule.
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_BCAST_H_
