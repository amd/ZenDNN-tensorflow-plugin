...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_MUTEX_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_MUTEX_H_
...
std::cv_status condition_variable::wait_for(
  ...
  return amd_cpu_plugin::internal::wait_until_system_clock(
      &this->cv_, &lock.mutex()->mu_, std::chrono::system_clock::now() + dur);
}

}  // namespace amd_cpu_plugin

#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_MUTEX_H_
