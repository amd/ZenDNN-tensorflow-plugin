...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_LOGGING_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_LOGGING_H_
...
#define _TF_LOG_INFO                                         \
  ::amd_cpu_plugin::internal::LogMessage(__FILE__, __LINE__, \
                                         ::amd_cpu_plugin::INFO)
#define _TF_LOG_WARNING                                      \
  ::amd_cpu_plugin::internal::LogMessage(__FILE__, __LINE__, \
                                         ::amd_cpu_plugin::WARNING)
#define _TF_LOG_ERROR                                        \
  ::amd_cpu_plugin::internal::LogMessage(__FILE__, __LINE__, \
                                         ::amd_cpu_plugin::ERROR)
#define _TF_LOG_FATAL \
  ::amd_cpu_plugin::internal::LogMessageFatal(__FILE__, __LINE__)
...
#define VLOG_IS_ON(lvl)                                                   \
  (([](int level, const char* fname) {                                    \
    static const bool vmodule_activated =                                 \
        ::amd_cpu_plugin::internal ::LogMessage::VmoduleActivated(fname,  \
                                                                  level); \
...
#define VLOG(level)                                                  \
  ...
  ? (void)0                                                          \
  : ::amd_cpu_plugin::internal::Voidifier() &                        \
          ::amd_cpu_plugin::internal::LogMessage(__FILE__, __LINE__, \
                                                 amd_cpu_plugin::INFO)
...
#define DVLOG(verbose_level)           \
  ...
  ::amd_cpu_plugin::internal::LogMessageNull()
#endif
...
#define LOGGING_INTERNAL_STATEFUL_CONDITION(kind, condition, arg)   \
  for (bool logging_internal_stateful_condition_do_log(condition);  \
    ...
    for (static ::amd_cpu_plugin::internal::Log##kind##State        \
...
#define TF_DEFINE_CHECK_OP_IMPL(name, op)                                      \
  ...
  inline string* name##Impl(const T1& v1, const T2& v2,                        \
    ...
    if (TF_PREDICT_TRUE(v1 op v2))                                             \
      ...
      return ::amd_cpu_plugin::internal ::MakeCheckOpString(v1, v2, exprtext); \
  }                                                                            \
...
#define CHECK_OP_LOG(name, op, val1, val2)                         \
  while (::amd_cpu_plugin::internal::CheckOpString _result{        \
      ::amd_cpu_plugin::internal::name##Impl(                      \
          ::amd_cpu_plugin::internal::GetReferenceableValue(val1), \
          ::amd_cpu_plugin::internal::GetReferenceableValue(val2), \
          #val1 " " #op " " #val2)})                               \
  ::amd_cpu_plugin::internal::LogMessageFatal(__FILE__, __LINE__)  \
      << *(_result.str_)
...
#define CHECK_NOTNULL(val)                  \
  ::amd_cpu_plugin::internal::CheckNotNull( \
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_LOGGING_H_
