...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_PLATFORM_TYPES_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_PLATFORM_TYPES_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_PLATFORM_TYPES_H_
