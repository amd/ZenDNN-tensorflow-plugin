...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_DEVICE_NAME_UTILS_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_DEVICE_NAME_UTILS_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_DEVICE_NAME_UTILS_H_
