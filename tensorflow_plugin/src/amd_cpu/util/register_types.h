...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_REGISTER_TYPES_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_REGISTER_TYPES_H_
...
#define TF_CALL_int32(m) m(::amd_cpu_plugin::int32)
#define TF_CALL_uint32(m) m(::amd_cpu_plugin::uint32)
#define TF_CALL_uint8(m) m(::amd_cpu_plugin::uint8)
#define TF_CALL_int16(m) m(::amd_cpu_plugin::int16)

#define TF_CALL_int8(m) m(::amd_cpu_plugin::int8)
#define TF_CALL_string(m) m(::amd_cpu_plugin::tstring)
#define TF_CALL_tstring(m) m(::amd_cpu_plugin::tstring)
#define TF_CALL_resource(m)   // m(::amd_cpu_plugin::ResourceHandle)
#define TF_CALL_variant(m)    // m(::amd_cpu_plugin::Variant)
#define TF_CALL_complex64(m) m(::amd_cpu_plugin::complex64)
#define TF_CALL_int64(m) m(::amd_cpu_plugin::int64)
...
#define TF_CALL_complex128(m) m(::amd_cpu_plugin::complex128)
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_REGISTER_TYPES_H_
