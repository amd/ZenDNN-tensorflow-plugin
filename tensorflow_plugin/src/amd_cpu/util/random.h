...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_RANDOM_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_RANDOM_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_RANDOM_H_
