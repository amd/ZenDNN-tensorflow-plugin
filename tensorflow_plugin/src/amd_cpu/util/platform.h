...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_PLATFORM_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_PLATFORM_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_PLATFORM_H_
