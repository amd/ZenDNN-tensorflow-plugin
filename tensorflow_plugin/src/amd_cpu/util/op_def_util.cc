...
//         TF_RETURN_IF_ERROR(AllowedTypeValue(static_cast<DataType>(dt),
//         attr));
//       }
...
//     bool found = false;
//     for (StringPiece valid : {"string", "int", "float", "bool", "type",
//     "shape",
//                               "tensor", "func"}) {
...
//           graph_def_version, ". It has been removed in version ",
//           dep.version(),
//           ". ", dep.explanation(), ".");
//     } else {
