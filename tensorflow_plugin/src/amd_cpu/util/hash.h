...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_HASH_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_HASH_H_
...
using StringPieceHasher = ::amd_cpu_plugin::hash<StringPiece>;
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_HASH_H_
