...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TSTRING_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TSTRING_H_
...
#include "tensorflow_plugin/src/amd_cpu/util/ctstring.h"
...
// amd_cpu_plugin::tstring is the scalar type for DT_STRING tensors.
//
...
// amd_cpu_plugin.  The primary purpose of tstring is to provide a unified and
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TSTRING_H_
