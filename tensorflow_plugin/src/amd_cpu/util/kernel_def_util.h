...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_KERNEL_DEF_UTIL_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_KERNEL_DEF_UTIL_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_KERNEL_DEF_UTIL_H_
