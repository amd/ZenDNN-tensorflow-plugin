...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TYPES_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TYPES_H_
...
template <>
struct DataTypeToEnum<long> {  // NOLINT(runtime/int)
  static DataType v() { return value; }
  static DataType ref() { return MakeRefType(value); }
  static constexpr DataType value =
      sizeof(long) == 4 ? DT_INT32 : DT_INT64;  // NOLINT(runtime/int)
};
template <>
struct IsValidDataType<long> {  // NOLINT(runtime/int)
  static constexpr bool value = true;
};
template <>
struct EnumToDataType<DT_INT64> {
  typedef amd_cpu_plugin::int64 Type;
};

template <>
struct DataTypeToEnum<unsigned long> {  // NOLINT(runtime/int)
  static DataType v() { return value; }
  static DataType ref() { return MakeRefType(value); }
  static constexpr DataType value =
      sizeof(unsigned long) == 4  // NOLINT(runtime/int)
          ? DT_UINT32
          : DT_UINT64;
};
template <>
struct IsValidDataType<unsigned long> {  // NOLINT(runtime/int)
  static constexpr bool value = true;
};
template <>
struct EnumToDataType<DT_UINT64> {
  typedef amd_cpu_plugin::uint64 Type;
};

template <>
struct DataTypeToEnum<long long> {  // NOLINT(runtime/int)
  static DataType v() { return DT_INT64; }
  static DataType ref() { return MakeRefType(DT_INT64); }
  static constexpr DataType value = DT_INT64;
};
template <>
struct IsValidDataType<long long> {  // NOLINT(runtime/int)
  static constexpr bool value = true;
};

template <>
struct DataTypeToEnum<unsigned long long> {  // NOLINT(runtime/int)
...
template <>
struct IsValidDataType<unsigned long long> {  // NOLINT(runtime/int)
  static constexpr bool value = true;
};
...
//// GPUs, we would like to keep int operations on host for performance
/// concerns. / But for TPUs (and other devices), int operations are placed on
/// device.
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TYPES_H_
