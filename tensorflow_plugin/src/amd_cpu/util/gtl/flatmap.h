...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_FLATMAP_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_FLATMAP_H_
...
#include "tensorflow_plugin/src/amd_cpu/util/gtl/flatrep.h"
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_FLATMAP_H_
