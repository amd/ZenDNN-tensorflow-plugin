...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_ARRAY_SLICE_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_ARRAY_SLICE_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_ARRAY_SLICE_H_
