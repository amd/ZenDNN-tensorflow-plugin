...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_MAP_TRAITS_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_MAP_TRAITS_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_GTL_MAP_TRAITS_H_
