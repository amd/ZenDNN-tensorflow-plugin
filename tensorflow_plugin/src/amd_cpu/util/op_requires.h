...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_OP_REQUIRES_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_OP_REQUIRES_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_OP_REQUIRES_H_
