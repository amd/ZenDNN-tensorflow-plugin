...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_CTSTRING_INTERNAL_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_CTSTRING_INTERNAL_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_CTSTRING_INTERNAL_H_
