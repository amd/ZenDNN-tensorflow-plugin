...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TENSOR_SHAPE_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TENSOR_SHAPE_H_
...
using amd_cpu_plugin::TensorShapeProto;
// END_SKIP_DOXYGEN
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_TENSOR_SHAPE_H_
