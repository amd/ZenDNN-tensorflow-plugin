...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_BOUNDS_CHECK_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_BOUNDS_CHECK_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_UTIL_BOUNDS_CHECK_H_
