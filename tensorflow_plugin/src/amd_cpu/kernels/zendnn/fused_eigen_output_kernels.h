...
#ifndef TENSORFLOW_PLUGIN_SRC_AMD_CPU_KERNELS_ZENDNN_FUSED_EIGEN_OUTPUT_KERNELS_H_
#define TENSORFLOW_PLUGIN_SRC_AMD_CPU_KERNELS_ZENDNN_FUSED_EIGEN_OUTPUT_KERNELS_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_AMD_CPU_KERNELS_ZENDNN_FUSED_EIGEN_OUTPUT_KERNELS_H_
