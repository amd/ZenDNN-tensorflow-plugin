...
def amd_cpu_plugin_workspace(path_prefix = "", tf_repo_name = ""):
    """All external dependencies for TF builds (TF 2.16-2.19, Bazel 7.4.1, protobuf v3.21.9)

    All codebase dependencies (abseil, rules_cc, ZenDNN, etc.) are kept
    identical to TF 2.20 since the BUILD files and C++ code are shared.
    Only protobuf and its wiring differ.
    """
    ...
    tf_http_archive(
        ...
        sha256 = "ead6fd97e504f1c56b17127d843494c251924c5411b889bc914d8ba2ba85d621",
        strip_prefix = "ZenDNN-zendnn-2026-WW12",
        urls = tf_mirror_urls("https://github.com/amd/ZenDNN/archive/refs/tags/zendnn-2026-WW12.tar.gz"),
    )
    ...
    tf_http_archive(
        ...
        sha256 = "df23a89e4cdfa7de2d81ee28190bd194413e47ff177c94076f845b32d7280344",
    ...
    # TF 2.19-specific: protobuf v3.21.9 (with protobuf.bzl for proto_gen)
    # additional_build_files injects bazel/ stubs so rules_cc 0.0.17 can
    # load @com_google_protobuf//bazel:cc_proto_library.bzl
    tf_http_archive(
        ...
        additional_build_files = {
            "//third_party/protobuf:bazel_BUILD": "bazel/BUILD",
            "//third_party/protobuf:bazel_cc_proto_library.bzl": "bazel/cc_proto_library.bzl",
        },
