...
load("@org_tensorflow_plugin//tensorflow_plugin/src/amd_cpu/util:build_config.bzl", "cc_proto")
...
template_rule(
    ...
    src = select({
        "@org_tensorflow_plugin//tensorflow_plugin:tf_version_2_12": "include/tensorflow/core/protobuf/graph_debug_info.proto",
